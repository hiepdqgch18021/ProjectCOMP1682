...
const stories = useSelector((state)=>state.stories.stories?.allStory);
// const storiesList = useSelector((state)=>state.stories.stories?.allStory);
...
useEffect(()=>{
  ...
  // if(user?.accessToken){
  // getAllStories(stories,dispatch)
  // }
  // if(user?.accessToken){
                        ...
                        <span>username</span>
                          ...
                          <UncontrolledDropdown nav inNavbar >
                            ...
                            <DropdownMenu >
                              ...
                              <DropdownItem coClick={()=>handleDelete(stories._id)}>Delete</DropdownItem>
                            </DropdownMenu>
                        ...
                        <ToastBody className="toast-body">
                          <div className="content-text-display">
                            <div className="story-content-display">
                              Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde aspernatur reprehenderit laboriosam animi consequatur commodi quis labore doloribus error, dolorem, quia, omnis accusamus ab nostrum molestiae alias illum fugiat recusandae.
                            </div>
